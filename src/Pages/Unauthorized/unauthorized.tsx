  ...
  return (
    ...
    <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
            ...
            <h1 className="mt-3 text-2xl font-semibold text-gray-800  md:text-3xl">Unauthorized</h1>
            <p className="mt-4 text-gray-500 dark:text-gray-400">Sorry, the page you are looking for is only for admins. If you are an admin, login and you will have acces.</p>

            <div className="flex items-center mt-6 gap-x-3">
                <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto   hover:bg-gray-100  dark:border-gray-700">
        ...
        <svg width="400" height="164" viewBox="0 0 514 164" fill="none" xmlns="http://www.w3.org/2000/svg">
