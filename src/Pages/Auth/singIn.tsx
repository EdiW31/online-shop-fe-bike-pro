            ...
            <form className='max-w-lg w-full mx-auto'>
              <div className='mb-12'>
                <h3 className='text-3xl font-bold text-yellow-400'>
                  Sign In into your Bike Pro. account!
                </h3>
              </div>
              <div className='mt-8'>
              ...
              <div className='mt-12'>
                ...
                <button
                  type='button'
                  className='w-max shadow-xl py-3 px-6 text-sm text-gray-300 font-medium ml-4 rounded-md bg-transparent bg-green-800 hover:bg-green-500 focus:outline-none'
                >
